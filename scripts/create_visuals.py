...
def create_voterteam_pair(input_csv: str, master_csv: str, min_votes: int = 0):
    ...
    plt.figure(figsize=(14, 10))
    bars = plt.barh(df_plot['label'], df_plot['bias0_mean_pct'], edgecolor='black', linewidth=1)

    colors = ['indianred' if x < 0 else 'mediumseagreen' for x in df_plot['bias0_mean_pct']]
...
def create_voterteam_pair_weighted(input_csv: str, master_csv: str, min_votes: int = 500):
    ...
    df_plot.loc[df_plot['team'] == "Illinois Fighting", 'team'] = "Illinois"
...
if __name__ == "__main__":
    ...
    create_voterteam_pair_weighted("voter_team_to_add/voter_team_cutoff0_weighted_illinois-fighting-illini.csv", "results/cfb/original_data/master_bias.csv", 0)