...
#cfb
ballot = pd.read_csv("/Users/albertbogdan/IML-FALL2025---Voter-Bias/original_data/college_football_polls_original.csv")
reference = pd.read_csv("/Users/albertbogdan/IML-FALL2025---Voter-Bias/output_data/cfb/cfb_cam_output.csv")
